...
@section('js')
    ...
    <script>
        document.querySelectorAll('.delete-button').forEach(button => {
            button.addEventListener('click', function(e) {
                ...
                Swal.fire({
                    title: 'هل أنت متأكد؟',
                    text: "هل انت متاكذ انك تريد حذف هذه الفاتورة؟",
                    icon: 'warning',
    ...
    <script>
        function archiveItem() {
            Swal.fire({
                title: 'ارشفة الفاتورة؟',
                text: "هل انت متأكد من ارشفة الفاتورة",
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                ...
                if (result.isConfirmed) {
                    // قم بإضافة كود الأرشفة هنا، مثال:
                    // window.location.href = "/archive-item-url";
                    Swal.fire(
                        'تمت الأرشفة!',
